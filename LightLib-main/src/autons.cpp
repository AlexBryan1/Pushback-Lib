...
void skills() {
    ...
    chassis.pid_wait_quick_chain();
    Hood.set(true);
    chassis.pid_turn_set(340_deg, 90);
    chassis.pid_wait_quick_chain();
...
void rush_mid_left() {
    ...
    chassis.pid_wait_quick_chain();
    pros::delay(500);
    chassis.pid_swing_set(ez::LEFT_SWING, 225_deg, 127, 28, ez::ccw);
...
void sevenball_left() {
    ...
    chassis.pid_turn_set(180_deg, 90, false);
    chassis.pid_wait_until(185_deg);
...
void sevenball_right() {
    Score.move(-127);
    Wings.set(false);
    chassis.pid_swing_set(ez::LEFT_SWING, -220_deg, 127, 50, ez::cw);
    chassis.pid_wait_until(-320_deg);
    Loader.set(false);
    chassis.pid_wait_until(-240_deg);
...
void split_left() {
    ...
    chassis.pid_wait_quick_chain();
    Loader.set(false);
    chassis.pid_swing_set(ez::LEFT_SWING, 305_deg, 127, 2, ez::cw);
    chassis.pid_wait_quick_chain();
    Loader.set(true);
    chassis.pid_drive_set(21_in, 80);
    chassis.pid_wait_quick_chain();
    Loader.set(false);
    pros::delay(100);
    ...
    pros::delay(1000);
    chassis.pid_swing_set(ez::RIGHT_SWING, 224_deg, 127, 50, ez::cw);
    chassis.pid_wait_quick_chain();
...
void delayed_split() {
    ...
    pros::delay(400);
    chassis.pid_swing_set(ez::RIGHT_SWING, 218_deg, 127, 27, ez::cw);
...
void split_right() {
    ...
    chassis.pid_wait_quick_chain();
    Loader.set(true);
    chassis.pid_drive_set(21.5_in, 127);
    chassis.pid_wait_quick_chain();
    Loader.set(false);
    pros::delay(300);
    ...
    chassis.pid_wait_until(-18.3_in);
    ...
    chassis.pid_drive_set(-25_in, 127);
    chassis.pid_wait_until(-20_in);
    chassis.pid_swing_set(ez::LEFT_SWING, 180_deg, 127, -20, ez::ccw);
    chassis.pid_wait_until(-150_deg);
    chassis.pid_drive_set(-15_in, 127);
    pros::delay(300);
    Hood.set(false);
...
void sawp(){
    ...
    chassis.pid_swing_set(ez::RIGHT_SWING, 0_deg, 127, 50, ez::ccw);
...
void partner_sawp(){
    chassis.pid_drive_set(-100_in, 50);
    pros::delay(1000);
}
// ┌─────────────────────────────────────────────────────────────────────────┐
// │  UTILITY FUNCTIONS                                                      │
